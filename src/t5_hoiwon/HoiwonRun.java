...
//					dao.setHoiwonInput(name,age,address,gender); // 회원가입메소드 호출
					...
					if(res != 1) System.out.println("회원에 가입 실패~~ ");
					...
					if(vo.getName() == null) System.out.println(name + "님 자료가 없습니다.");
						...
						switch(no) {
							...
							case 2:
								...
								break;
							case 3:
								System.out.print("수정할 성별을 입력하세요?(1.남자 2여자");
						...
						if(res != 1) System.out.println("수정 실패~~ ");
